...
const plans = [
  {
    ...
    title: 'Basic',
    description:
      'Price per Tax professional $2,500 Up to 1000 files $50/file',
    price: 69,
    permission: [0, 1],
    planList: {
      ...
      "Support": [
        "Standard email support (with reasonable response times).",
        "Access to knowledge base and FAQ resources."
      ]
    }
  },
  {
    ...
    title: 'Pro',
    description:
      'Price per Tax professional $2,500 Up to 1500 files $40/file',
    price: 129,
    permission: [0, 1, 2, 3],
    planList: {
      "Everything in the Basic plus": {
        ...
        "Support": [
          ...
          "Limited phone support (e.g., during business hours)."
        ]
      }
    }
  },
  {
    ...
    title: 'Enterprise',
    description:
      'Price per Tax professional $2,500 more than 1500 files $30/file',
    price: 599,
    ...
    planList: {
      "Everything in the Pro plus": {
        ...
        "Advanced Analytics": [
          "Deeper insights into client data, trends, and performance"
        ],
        "Integration Options": [
          "Seamless connection with other accounting or practice management software"
        ],
        ...
        "White-Labeling": [
          "Option to brand the software with the firm's logo and colors"
        ]
      }
    }
  }
